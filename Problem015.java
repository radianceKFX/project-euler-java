...
/******************** 4. Start the calculation ********************/
       ...
       /***** For smaller rectangles print out the paths for each node *****/
                if(horizontalSide<printLimitAllNodes 
                || verticalSide<printLimitAllNodes){
...
/************************* 6. Methods *************************/
    ...
    /**
     * Converts both {@code int} or {@code long} coordinates into a a String form,
     * so it can be more easily stored in the 'answers' TreeMap.
     * @param xLong this {@code long} is the x coordinate
     * @param yLong this {@code long} is the y coordinate
     * @return {@code String} of your coordinate in the format {@code x:y}
     */
    public static String coordinateString(long xLong, long yLong){
        return Long.toString(xLong)+":"+Long.toString(yLong);
    }
